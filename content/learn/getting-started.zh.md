...
## 安装 Zig
### 直接下载
这是最直接的获取 Zig 的方法：从[下载](/zh/download)页面为你的平台获取压缩包，
...
如果你对其他的工具感兴趣，可以查看[工具](/zh/tools/)章节。
...
## 下一步
**查看在[学习](/zh/learn)章节的其他资源**，请务必找到与你的 Zig 版本匹配的文档。
...
最后，如果你喜欢 Zig 并想加速 Zig 开发，[考虑捐助 Zig 软件基金会](/zh/zsf)
